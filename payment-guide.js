...
(() => {
  ...
  add([0],'旧金山酒店与金门大桥停车','现场支付','酒店停车以入住确认为准，原预留约30美元/晚；大桥东南停车场5美元/小时，最多连续3小时。',[
    '先到安妮女王酒店问清停车入口、是否有空位、可否反复进出、税是否另计；不要把酒店房费当已含停车。',
    '大桥停车用现场缴费机或 ParkMobile（停车缴费应用），按实际区域、车牌、时长付款并保存凭证。暖屋附近车位按当地牌示单独缴，不共享停车费。',
  ...
  add([4],'Academy Museum of Motion Pictures（学院电影博物馆）','备选；决定进馆再买','普通成人25美元/人，两人约人民币335元；额外活动与体验另核价。',[
    '从官方Tickets（门票）页选日期及入馆时段，核对两名成人后按结账页付款；保留电子票。这里只给常规门票参考，不把电影放映或颁奖模拟体验默认包含。',
    '当天下午已排天文台与晚餐；若时间不足直接删除博物馆，不提前买不能退的附加活动。'
  ...
  add([12],'两种渡轮：免费观景与去丹波区','一段免费，一段付费','Staten Island Ferry（史泰登岛渡轮）免费；NYC Ferry（纽约渡轮）单程4.50美元/人，两人约人民币60.30元。',[
  ...
  add([12],'下城与丹波区的可选门票','默认只外观／公共区域','帝国大厦外观、九一一纪念广场、布鲁克林大桥步行不等于购买观景台或博物馆门票。',[
  ...
  add([14,15],'曼哈顿→机场酒店→航站楼','交通费用另付；酒店信息待补','JFK机场与曼哈顿的黄色出租车基本固定价70美元，附加费、过路费、小费另计；机场附近酒店不自动适用此固定价。',[
    ...
    '入住时确认凌晨接驳是否收费、是否必须预约、是否只到Federal Circle（联邦环线站）。如只到该站，还要转机场捷运去航站楼。没有可用班次就前晚约车，不在凌晨临时碰运气。'
