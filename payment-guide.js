...
(() => {
  ...
  add([4],'Academy Museum of Motion Pictures（学院电影博物馆）','计划参观；尚未收到购票确认','普通成人25美元/人，两人约人民币335元；额外活动与体验另核价。',[
    '从官方Tickets（门票）页选日期及入馆时段，核对两名成人后按结账页付款；保留电子票。这里只给常规门票参考，不把电影放映或颁奖模拟体验默认包含。',
    '计划11:30左右入馆、13:30离馆。若上午迟到，缩短馆内停留；额外体验不要买会挤占好莱坞湖公园和天文台时间的场次。'
