...
(() => {
  ...
  day('2026-10-11','10月11日 · Central Park（中央公园）、The Met（大都会艺术博物馆）、Casa Mono（卡萨莫诺）与 Broadway（百老汇）','公园与博物馆 → 已订午餐 → 格林威治村 → 《阿拉丁》候选',[
    ...
    ['11:45—12:30','打车去 Casa Mono（卡萨莫诺）','从博物馆正门叫正规网约车到 52 Irving Place（欧文广场街52号）。Google Maps（谷歌地图）当前驾车与公交均约31分钟；打车主要减少步行与换乘，并非保证省时。连同叫车预留40–45分钟，目标12:30到达。不在已订午餐前插入 Flatiron Building（熨斗大厦）。'],
